...
<div class="container" style="margin-top: 130px">
  <div class="row">
    <div class="col-lg-7 mx-auto" >
    	...
    	<br><br><br>
    	<form action="<?php echo site_url('soal/aksi_latihan3'); ?>" method="post">		
			Soal no 3<br><br>
            Perhatikan gambar berikut. 
            <img src="<?php echo base_url('assets/soal1/3.png') ?>" width="70%"><br><br>
            <ol type="a">
                <li>
                    &ensp;Arah arus listrik ditandai dengan huruf &ensp;<input type="text" name="jawaban1" required>
                </li>
                <li>
                    &ensp;Arah gerakan elektron ditandai dengan huruf &ensp;<input type="text" name="jawaban2" required>
                </li>
            </ol>
			<br/><br><br>
