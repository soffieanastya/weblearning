...
<div class="container" style="margin-top: 130px">
  <div class="row">
    <div class="col-lg-7 mx-auto" >
    	...
    	<br><br><br>
    	<form action="<?php echo site_url('soal/aksi_latihan4'); ?>" method="post">		
			Soal no 4<br><br>
            Isilah kolom kosong di bawah ini sesuai dengan satuannya yang sesuai. <br>
            Pak Adi mempunyai pemanas listrik yang memiliki beda potensial 40 &ensp;<input type="text" name="jawaban1" required> dan kuat arus listrik 4 &ensp;<input type="text" name="jawaban2" required>
			<br/><br><br>
