...
<div class="container" style="margin-top: 130px">
  <div class="row">
    <div class="col-lg-7 mx-auto">
    	...
    	<br><br>
    	<form action="<?php echo site_url('soal_pemanasan/aksi_thyristor'); ?>" method="post">	
			Thyristor akan &ensp;<input type="text" name="jawaban1" required> arus listrik dari anoda ke katoda jika pada kaki gate diberi arus ke arah katoda <br/><br><br>
    ...
    <div class="portfolio-modal-dialog bg-white" style="width: 60%; height: 100px">
      ...
      <div class="text-center">
            ...
            <p class="mb-5" align="justify">
              Thyristor merupakan salah satu komponen elektronika yang memiliki bagian anoda, katoda, dan gate.
            </p>
