...
<div class="container" style="margin-top: 130px">
  <div class="row">
    <div class="col-lg-7 mx-auto" >
    	...
    	<br><br><br>
    	<form action="<?php echo site_url('soal/aksi_latihan2'); ?>" method="post">		
    			Soal no 2<br><br>
    			Arus listrik  <input type="text" name="jawaban" required> (bolak-balik/direct current/DC)biasanya digunakan untuk alat listrik ber-kekuatan/daya kecil<br/><br><br>
