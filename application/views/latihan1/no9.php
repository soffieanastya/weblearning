...
<div class="container" style="margin-top: 130px">
  <div class="row">
    <div class="col-lg-7 mx-auto" >
    	...
    	<br><br>
    	<form action="<?php echo site_url('soal/aksi_latihan9'); ?>" method="post">		
			Soal no 9<br><br>
            Perhatikan gambar berikut <br>
            <img src="<?php echo base_url('assets/soal1/9.png') ?>" width="15%"><br>
            Nilai kapasitansi dari kapasitor tersebut adalah &ensp;<input type="text" name="jawaban1" required> <br>
			<br><br><br>
