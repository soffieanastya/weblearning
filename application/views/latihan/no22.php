...
<div class="container" style="margin-top: 130px">
  <div class="row">
    <div class="col-lg-7 mx-auto">
    	...
    	<br><br>
    	<form action="<?php echo site_url('soal_pemanasan/aksi_kapasitor'); ?>" method="post">	
			Kapasitor merupakan salah satu jenis komponen elektronika yang memiliki kemampuan untuk &ensp;<input type="text" name="jawaban1" required> muatan listrik selama waktu tertentu. <br/><br><br>
    ...
    <div class="portfolio-modal-dialog bg-white" style="width: 60%; height: 100px">
      ...
      <div class="text-center">
            ...
            <p class="mb-5" align="justify">
              Kapasitor memiliki fungsi yang sama seperti accu dalam skala kecil.  Terdapat tiga jenis kondisi yang memungkinkan pada potensial listrik, yaitu potensial listrik tinggi, rendah, dan netral.
            </p>
