...
<div class="container" style="margin-top: 130px">
  <div class="row">
    <div class="col-lg-7 mx-auto">
    	...
    	<br><br>
    	<form action="<?php echo site_url('soal_pemanasan/aksi_induktor'); ?>" method="post">	
			Dalam arus searah (DC), inductor berfungsi untuk &ensp;<input type="text" name="jawaban1" required> arus searah. <br/><br><br>
    ...
    <div class="portfolio-modal-dialog bg-white" style="width: 60%; height: 100px">
      ...
      <div class="text-center">
            ...
            <p class="mb-5" align="justify">
              Terdapat beberapa fungsi induktor, salah satunya yaitu ada yang berperan dalam arus listrik
            </p>
