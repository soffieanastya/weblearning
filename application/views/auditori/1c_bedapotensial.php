  ...
  <div class="container text-center" style="margin-top: 120px">
    <div class="row">
      ...
      <div class="col-lg-8 mx-auto">
        <h2 class="text-secondary text-uppercase mb-0">BEDA POTENSIAL/TEGANGAN</h2>
        <br><br>

        <div class="text-left">
          <video controls style="width: 100%">
              <source src="<?php echo base_url('auditori/bag1/3.mp4') ?>" type="video/mp4">
          </video>
        </div>
        <!-- 
        <audio src="<?php echo base_url('auditori/1/4_bedapotensial/1.mp3') ?>" controls></audio><br>
        -->
        <div class="row">
            ...
            <div class="col-lg-6"></div>
              <div class="col-lg-3 text-right" style="padding-top: 50px; padding-bottom: 50px">
                <a href="<?php echo site_url('soal_pemanasan/bedapotensial') ?>" >
