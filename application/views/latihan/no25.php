...
<div class="container" style="margin-top: 130px">
  <div class="row">
    <div class="col-lg-7 mx-auto">
    	...
    	<br><br>
    	<form action="<?php echo site_url('soal_pemanasan/aksi_transistor'); ?>" method="post">	
			Ciri utama transistor yaitu memiliki &ensp;<input type="text" name="jawaban1" required> kaki <br/><br><br>
    ...
    <div class="portfolio-modal-dialog bg-white" style="width: 60%; height: 100px">
      ...
      <div class="text-center">
            ...
            <p class="mb-5" align="justify">
              Transistor merupakan komponen elektronika yang memiliki ciri khusus pada banyak kakinya.
            </p>
