...
<div class="container" style="margin-top: 130px">
  <div class="row">
    <div class="col-lg-7 mx-auto" >
    	...
    	<br><br>
    	<form action="<?php echo site_url('soal/aksi_latihan10'); ?>" method="post">		
			Soal no 10<br><br>
            Perhatikan gambar berikut <br>
            <img src="<?php echo base_url('assets/soal1/10.png') ?>" width="50%"><br>
            Nilai hambatan total rangkaian tersebut adalah &ensp;<input type="text" name="jawaban1"  required>ꭥ<br>
			<br><br><br>
