...
<div class="container" style="margin-top: 130px">
  <div class="row">
    <div class="col-lg-7 mx-auto">
    	...
    	<br><br>
    	<form action="<?php echo site_url('soal_pemanasan/aksi_potensial'); ?>" method="post">	
			Jika sebuah benda mempunyai jumlah elektron yang sama banyaknya dengan jumlah proton, benda tersebut memiliki potensial listrik &ensp;<input type="text" name="jawaban1" required><br/><br><br>
    ...
    <div class="portfolio-modal-dialog bg-white" style="width: 60%; height: 100px">
      ...
      <div class="text-center">
            ...
            <p class="mb-5" align="justify">
              Potensial listrik merupakan banyaknya muatan yang terdapat dalam suatu benda. Terdapat tiga jenis kondisi potensial listrik, yaitu potensial listrik netral, potensial listrik tinggi, dan potensial listrik rendah.
            </p>
