...
<div class="container" style="margin-top: 130px">
  <div class="row">
    <div class="col-lg-7 mx-auto">
    	...
    	<br><br>
    	<form action="<?php echo site_url('soal_pemanasan/aksi_resistansi'); ?>" method="post">	
			Satuan dari resistansi adalah &ensp;<input type="text" name="jawaban1" required><br/><br><br>
