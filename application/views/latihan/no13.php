...
<div class="container" style="margin-top: 130px">
  <div class="row">
    <div class="col-lg-7 mx-auto">
    	...
    	<br><br>
    	<form action="<?php echo site_url('soal_pemanasan/aksi_arus'); ?>" method="post">	
			Arus listrik &ensp;<input type="text" name="jawaban1" required> biasanya digunakan untuk alat listrik ber-kekuatan/daya kecil <br/><br><br>
    ...
    <div class="portfolio-modal-dialog bg-white" style="width: 60%; height: 100px">
      ...
      <div class="text-center">
            ...
            <p class="mb-5" align="justify">
              Jika dilihat berdasarkan arahnya, arus listrik dibedakan menjadi dua kategori, yaitu arus listrik bolak-balik dan arus listrik searah
            </p>
