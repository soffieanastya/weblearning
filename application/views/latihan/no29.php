...
<div class="container" style="margin-top: 130px">
  <div class="row">
    <div class="col-lg-7 mx-auto">
    	...
    	<br><br>
    	<form action="<?php echo site_url('soal_pemanasan/aksi_tranducer'); ?>" method="post">	
			Komponen elektronika yang termasuk ke dalam tranducer di antaranya LDR, yang memiliki singkatan dari &ensp;<input type="text" name="jawaban1" required> Dependent Resistance <br/><br><br>
    ...
    <div class="portfolio-modal-dialog bg-white" style="width: 60%; height: 100px">
      ...
      <div class="text-center">
            ...
            <p class="mb-5" align="justify">
              Komponen elektronika yang termasuk ke dalam tranducer di antaranya LDR, NTC, dan PTC.
            </p>
