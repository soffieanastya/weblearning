  ...
  <div class="container text-center" style="margin-top: 120px">
    <div class="row">
      ...
      <div class="col-lg-8 mx-auto" style="text-align: left">
        <h2 class="text-secondary text-uppercase mb-0" style="text-align: center">KELISTRIKAN</h2>
        <br>
       `Energi Listrik
        <video controls style="width: 100%">
            <source src="<?php echo base_url('auditori/bag1/1c.mp4') ?>" type="video/mp4">
        </video>
        <br><br>
        Apa itu muatan listrik?
        <video controls style="width: 100%">
            <source src="<?php echo base_url('auditori/bag1/1d.mp4') ?>" type="video/mp4">
        </video>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 text-right" style="padding-top: 50px; padding-bottom: 50px">
              <a href="<?php echo site_url('soal_pemanasan/kelistrikan') ?>" >
