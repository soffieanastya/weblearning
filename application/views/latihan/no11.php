...
<div class="container" style="margin-top: 130px">
  <div class="row">
    <div class="col-lg-7 mx-auto">
    	...
    	<br><br>
    	<form action="<?php echo site_url('soal_pemanasan/aksi_kelistrikan'); ?>" method="post">	
			Suatu benda yang memiliki elektron lebih banyak disbanding proton, berarti benda tersebut memiliki aliran listrik dengan listrik bermuatan &ensp;<input type="text" name="jawaban1" required><br/><br><br>
    ...
    <div class="portfolio-modal-dialog bg-white" style="width: 60%; height: 100px">
      ...
      <div class="text-center">
            ...
            <p class="mb-5" align="justify">
              Muatan listrik merupakan materi/bahan suatu, benda yang membuatnya mengalami gaya pada benda lain yang berdekatan dan memiliki muatan listrik. Benyamin franklin menamakan kedua jenis aliran listrik dengan listrik bermuatan positif serta listrik bermuatan negatif.
            </p>
