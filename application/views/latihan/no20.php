  ...
  <div class="row">
    <div class="col-lg-7 mx-auto">
    	...
    	<form action="<?php echo site_url('soal_pemanasan/aksi_kelistrikan'); ?>" method="post">	
			Jika jumlah elektron lebih sedikit dari jumlah proton, maka benda tersebut memiliki potensial listrik &ensp;<input type="text" name="jawaban1" required><br/><br><br>
