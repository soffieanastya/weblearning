...
<div class="container" style="margin-top: 130px">
  <div class="row">
    <div class="col-lg-7 mx-auto" >
    	...
    	<br><br><br>
    	<form action="<?php echo site_url('soal/aksi_latihan8'); ?>" method="post">		
			Soal no 8<br><br>
            Perhatikan gambar komponen elektronika berikut <br>
            <img src="<?php echo base_url('assets/soal1/8.png') ?>" width="50%"><br><br>
            Besar daya dari resistor tersebut sebesar &ensp;<input type="text" name="jawaban1" required> <br>
