  ...
  <div class="container text-center" style="margin-top: 120px">
    <div class="row">
      ...
      <div class="col-lg-8 mx-auto">
        <h2 class="text-secondary text-uppercase mb-0">TRANDUCER</h2>
        <br><br>
        <video controls style="width: 100%">
            <source src="<?php echo base_url('auditori/bag2/9a.mp4') ?>" type="video/mp4">
        </video>
        <!-- <video controls style="width: 100%">
            <source src="<?php //echo base_url('auditori/bag2/9b.mp4') ?>" type="video/mp4">
        </video> -->

         <!-- <audio src="<?php //echo base_url('auditori/2/10/1.mp3') ?>" controls></audio><br> -->
        ...
        <div class="row">
            ...
            <div class="col-lg-3 text-right" style="padding-top: 50px; padding-bottom: 50px">
                <a href="<?php echo site_url('soal_pemanasan/tranducer') ?>" >
