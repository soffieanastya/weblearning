...
<div class="container" style="margin-top: 130px">
  <div class="row">
    <div class="col-lg-7 mx-auto" >
    	...
    	<br><br><br>
    	<form action="<?php echo site_url('soal/aksi_latihan5'); ?>" method="post">		
			Soal no 5<br><br>
            Anton membeli sebuah lampu pijar. Pada lampu pijar tersebut tertulis 24 V, 3 ohm sebesar 20W. Nilai beda potensial dan hambatan dari lampu pijar tersebut adalah… <br>
            Beda potensial &ensp;<input type="text" name="jawaban1" required> <br>
            Hambatan &ensp;<input type="text" name="jawaban2" required>
